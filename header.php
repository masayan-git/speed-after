...
<head>
  ...
  <link media="print" onload="this.media='all'" href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@400;500;700&family=Noto+Serif+JP:wght@400&display=swap" rel="stylesheet"> -->
  <!-- JavaScript -->
...
<header class="header">
  <div class="header__container">
    <h1 class="header__title"><a href="<?= home_url(); ?>" class="header__title-link">After</a></h1>
    ...
    <nav class="header__nav" id="js-header">
      <ul class="header__list drawer-header__list">
        ...
        <li class="header__item"><a href="<?= home_url(); ?>" class="header__link">企業概要</a></li>
        <li class="header__item"><a href="<?= home_url(); ?>" class="header__link">ブログ</a></li>
        <li class="header__item"><a href="<?= home_url(); ?>" class="header__link header__link--contact">お問い合わせ</a></li>
      </ul>
    </nav>
